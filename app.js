...
app.get("/agenda/", async (request, response) => {
  ...
  console.log(imMatch(date, "yyyy-MM-dd"));
    ...
    if (status === "TO DO" || status === "IN PROGRESS" || status === "DONE") {
      if (
        ...
        if (isMatch(dueDate, "yyyy-MM-dd")) {
          ...
          const postToDoQuery = `INSERT INTO todo (id,todo,priority,category,status,due_date) VALUES (${id}, '${todo}', '${priority}', '${category}', '${status}','${postNewDueDate}');`;
